...
var TextEditorScroll = Ember.Mixin.create({
    /**
    ...
    adjustScrollPosition: function () {
        ...
        if (scrollInfo.isCursorAtEnd &&
            (scrollInfo.diff >= scrollInfo.top) && (scrollInfo.diff < scrollInfo.top + scrollInfo.padding)) {
...
export default TextEditorScroll;
