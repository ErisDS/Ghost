...
let config = {
    ...
    transports: [
        new transports.File({filename: 'test.combined.log', level: 'debug', maxsize: 80, maxFiles: 6, tailable: true})
    ]
};
...
logger.error(new Error('bad things 1'));
logger.info('hello world 2');
logger.error(new Error('bad things 2'));
logger.info('hello world 3');
logger.error(new Error('bad things 3'));
