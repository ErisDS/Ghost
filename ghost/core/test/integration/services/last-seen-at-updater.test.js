...
describe('Last Seen At Updater', function () {
  ...
  describe('updateLastSeenAtWithoutKnownLastSeen', function () {
    it('works', async function () {
      ...
      await membersEvents.lastSeenAtUpdater.updateLastSeenAtWithoutKnownLastSeen(
        memberId,
        firstDate,
      );
  ...
  describe('cachedUpdateLastSeenAt', function () {
    it('works', async function () {
      ...
      await membersEvents.lastSeenAtUpdater.cachedUpdateLastSeenAt(
        memberId,
        previousLastSeen,
        firstDate,
      );
    ...
    it('does not call updateLastSeenAt multiple times for the same member on the same day', async function () {
      ...
      await Promise.all([
        membersEvents.lastSeenAtUpdater.cachedUpdateLastSeenAt(
          memberId,
          previousLastSeen,
          firstDate,
        ),
