...
function createEmailService({ ghostServer } = {}) {
  ...
  return Object.assign(emailService, { controller, renderer: emailRenderer });
}

module.exports = { createEmailService, getPostUrl };
